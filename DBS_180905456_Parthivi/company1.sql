...
DROP TABLE DEPARTMENT1 CASCADE CONSTRAINTS;
...
INSERT INTO DEPARTMENT1 VALUES ('Research', 5, '333445555', DATE '1988-05-22');

INSERT INTO DEPARTMENT1 VALUES ('Administration', 4, '987654321', DATE '1995-01-01');

INSERT INTO DEPARTMENT1 VALUES ('Headquarters', 1, '888665555', DATE '1981-06-19');

-- this alter is needed to allow PROJECT and DEPARTMENT to reference each other

ALTER TABLE EMPLOYEE ADD FOREIGN KEY (Dno) REFERENCES DEPARTMENT1 (Dnumber);
